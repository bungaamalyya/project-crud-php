...
<body>
    <nav>
        <h1>
            ABSENSI PIKET SMK PLUS PELITA NUSANTARA
        </h1>
    </nav>
    <div class="mx-auto">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="tanggal" name="tanggal" value="<?php date_default_timezone_set("Asia/Jakarta");
                            echo date('d-m-y H:i') ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="anggota_piket" name="anggota_piket"
                                value="<?php echo $anggota_piket ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
